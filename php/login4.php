    ...
    <style>
        ...
        * {
        ...
        .password-container input {
            width: 90%;
            padding-right: 40px;
            transition: all 0.3s ease; /* Animasi untuk input password */
        }
        ...
        .toggle-password {
            ...
            right: 35px;
            cursor: pointer;
            transition: transform 0.3s ease, color 0.3s ease; /* Tambahkan transition */
        }

        .toggle-password:hover {
            color: aqua;
            animation: eyeAnimation 0.5s ease-in-out; /* Tambahkan animasi */
        }
        ...
        .toggle-password.active {
            animation: eyeToggle 0.5s ease-in-out; /* Animasi saat di-klik */
        }
...
<body>
    ...
    <script>
        ...
        function togglePassword() {
            ...
            toggleIcon.classList.toggle('active'); // Tambahkan class active untuk animasi
        }
